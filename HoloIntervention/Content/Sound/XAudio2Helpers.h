...
static HRESULT SetupXAudio2( _In_ const WAVEFORMATEX* format, _In_ IXAPO* xApo, _Outptr_ IXAudio2** xAudio2, _Outptr_ IXAudio2SourceVoice** sourceVoice, IXAudio2VoiceCallback* callBacks = NULL )
{
  ...
  if ( SUCCEEDED( hr ) )
  {
    hr = xAudio2Instance->CreateSourceVoice( &sourceVoiceInstance, format, 0, XAUDIO2_DEFAULT_FREQ_RATIO, callBacks);
  }
